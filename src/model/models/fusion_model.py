    ...
    def build_loss(self, inputs, results, label_loss_fn_dict):
        ...
        for key, loss_fn in label_loss_fn_dict.items():
            if key == 'tagging':
                ...
                loss_weight = results.get("fusion_loss_weight", 1.0)
                prediction = results["tagging_output_fusion"]["predictions"]
                loss_dict["tagging_loss_fusion"] = loss_fn.calculate_loss(prediction, labels,
