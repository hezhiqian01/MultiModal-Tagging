...
from src.model.text_head import bert_utils
...
class BertModel(object):
    ...
    def __init__(self,
        ...
        with tf.variable_scope(scope, default_name="bert", reuse=self.reuse):
            ...
            with tf.variable_scope("pooler", reuse=self.reuse):
